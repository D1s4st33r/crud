<template>
  <b-container class="listContainer">
    <div class="formContainer">
      <b-form id="formCrud" @submit="createPro(post)" inline>
        <b-form-group id="nombre" label="Nombre del producto: " label-for="nombre">
          <b-form-input
            id="nombre"
            type="text"
            required
        ...
        <b-form-group id="total" label=" Cantidad: " label-for="total">
          <b-form-input
            id="cantidad"
            type="number"
            required
